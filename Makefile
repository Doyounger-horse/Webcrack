#############################################################################
# Makefile for building: Webcrack
# Generated by qmake (3.0) (Qt 5.5.0)
# Project:  Webcrack.pro
# Template: app
# Command: /usr/lib/qt/bin/qmake -o Makefile Webcrack.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = Webcrack1.0.0
DISTDIR = /home/vasseu_g/github/Webcrack/.tmp/Webcrack1.0.0
LINK          = g++
...
Makefile: Webcrack.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
